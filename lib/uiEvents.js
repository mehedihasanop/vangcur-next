...
// Added while building 22-account-page.html (AccountPage.js): same "dispatch into the
// void until the real component exists" pattern as the four above.
//   - openMembershipModal() -> 39-membership-progress-modal.html (Priority 4, not built)
//   - dlInvoiceById(id, 'acc') -> some invoice/PDF generator, not built anywhere yet —
//     no legacy section number covers it in the master prompt's progress table
export const OPEN_MEMBERSHIP_EVENT = 'vc:openMembership';
export const OPEN_INVOICE_EVENT = 'vc:openInvoice'; // detail: { orderId }
